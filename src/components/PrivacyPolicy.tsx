    ...
    return (
      <div className="min-h-screen bg-gray-100 flex items-center justify-center py-12 px-6">
        <div className="bg-white p-8 rounded-lg shadow-lg max-w-4xl w-full">
          ...
          FJU Christian Vibes our is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your personal information when you use our app. By using our app, you consent to the practices described in this Privacy Policy.
          </p>
            ...
            <ul className="list-disc pl-6 text-gray-700 mb-4">
              <li><strong>Personal Information</strong>: When you use the app, we may collect personal details such as:
                <ul className="list-inside">
                  ...
                  <li>Name: If provided, we may use this information to personalize your experience.</li>
                  <li>Password: Only collected for authentication if you choose to register or log in.</li>
                </ul>
              </li>
              <li><strong>Usage Data</strong>: This includes data about how you use the app, such as:
                <ul className="list-inside">
                  <li>Music you stream (e.g., tracks, playlists, artists).</li>
                  <li>Frequency and duration of streams.</li>
                  <li>Interactions with live-streamed music events.</li>
                </ul>
              </li>
              <li><strong>Advertising Data</strong>: We use Google AdMob to serve ads in the app. As a result, Google may collect anonymous data related to:
                <ul className="list-inside">
                  <li>Device identifiers</li>
                  <li>Advertising identifiers</li>
                  <li>Interaction with ads (e.g., clicks or impressions)</li>
                </ul>
              </li>
            </ul>
          </section>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 text-gray-700 mb-4">
              <li><strong>Provide Live Streaming</strong>: To deliver the live music streams, recommend content based on user preferences, and manage streaming sessions.</li>
              <li><strong>Ad Personalization</strong>: To serve ads via Google AdMob, based on your device information and usage data.</li>
              <li><strong>App Improvement</strong>: To analyze how users interact with the app, troubleshoot issues, and enhance the app's performance and features.</li>
              <li><strong>Communication</strong>: To send you notifications related to live streams, new features, or app updates (if applicable).</li>
            </ul>
          </section>
  
          <section className="mb-8">
            <h2 className="text-xl font-semibold text-gray-800 mb-4">3. How We Store and Secure Your Information</h2>
            <p className="text-gray-700 mb-4">
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 text-gray-700 mb-4">
              <li><strong>With Service Providers</strong>: We may share information with third-party service providers who assist in app operations, such as Firebase for live streaming, MongoDB Atlas for data storage, and Google AdMob for ads.</li>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 text-gray-700 mb-4">
              ...
              <li><strong>Opt-Out of Ads:</strong> You can manage ad preferences via your device's settings (e.g., opt-out of personalized ads).</li>
            </ul>
          </section>
          ...
          <section className="mb-8">
            <h2 className="text-xl font-semibold text-gray-800 mb-4">8. Google AdMob</h2>
            <p className="text-gray-700 mb-4">
              Our app uses Google AdMob to serve advertisements. Google AdMob collects and processes certain anonymous data, including device identifiers and advertising data, for the purpose of personalizing ads and measuring ad performance.
            </p>
            <p className="text-gray-700 mb-4">
              For more information on how Google handles your data, refer to their <a href="https://www.google.com/policies/privacy/" className="text-blue-500 underline">Privacy Policy</a>.
            </p>
          </section>
